...
use newdb3;
INSERT INTO users (
  id, name, password, role, position, level, department_id, skills, email
) VALUES
('quocanhng2804@gmail.com', 'anhnvq', '123', 'MEMBER', 'QA Tester', 'Junior', 'd1', 'Testing, Automation', 'quocanhng2804@gmail.com'),
-- hoanglam
('hoanglam@holagroup.com.vn', 'hoanglam', '123', 'MEMBER', 'Developer', 'Junior', 'd1', 'JavaScript, React', 'hoanglam@holagroup.com.vn'),

-- hoanglan
('hoanglan@holagroup.com.vn', 'hoanglan', '123', 'MEMBER', 'Frontend Developer', 'Junior', 'd1', 'HTML, CSS, React', 'hoanglan@holagroup.com.vn'),

-- longho
('longho@holagroup.com.vn', 'longho', '123', 'MEMBER', 'Backend Developer', 'Junior', 'd1', 'Node.js, MySQL', 'longho@holagroup.com.vn'),

-- ngocan
('ngocan@holagroup.com.vn', 'ngocan', '123', 'MEMBER', 'Project Coordinator', 'Junior', 'd2', 'Management, Excel', 'ngocan@holagroup.com.vn'),

-- thanhhoa
('thanhhoa@holagroup.com.vn', 'thanhhoa', '123', 'MEMBER', 'Sales Executive', 'Junior', 'd4', 'Sales, Communication', 'thanhhoa@holagroup.com.vn'),

-- thinhtq
('thinhtq@holagroup.com.vn', 'thinhtq', '123', 'MEMBER', 'QA Tester', 'Junior', 'd1', 'Testing, Automation', 'thinhtq@holagroup.com.vn'),
-- qa
('quocanhng2804@gmail.com', 'anhnvq', '123', 'MEMBER', 'QA Tester', 'Junior', 'd1', 'Testing, Automation', 'quocanhng2804@gmail.com');