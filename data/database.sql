...
CREATE TABLE IF NOT EXISTS users (
    ...
    department VARCHAR(100), -- Vd: Engineering
...
-- SEED DATA (DEMO)
-- =====================================
INSERT INTO users (id, name, password, role, position, level, department, skills, email) VALUES
('1024', 'Nguyễn Văn An', '123', 'MANAGER', 'Project Manager', 'Senior', 'Management', 'Management, Agile, Jira', 'an.nguyen@hola.com'),
('4592', 'Trần Thị Bình', '123', 'MEMBER', 'Frontend Developer', 'Mid-Level', 'Engineering', 'React, TypeScript, Tailwind', 'binh.tran@hola.com'),
('8831', 'Lê Minh Cường', '123', 'MEMBER', 'Backend Developer', 'Junior', 'Engineering', 'Node.js, MySQL, Docker', 'cuong.le@hola.com');
